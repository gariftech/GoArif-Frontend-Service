...
import { AudioWaveform, File, FileWarning, MessageCircle, UploadCloud, WholeWord } from "lucide-react";
import { apiListPromptFilesum } from "../../../../libs/api";

const itemsFile = [
  { name: "File Upload", key: "FileUpload", image: <UploadCloud height={20} /> },
  { name: "Transcribe", key: "Transcribe", image: <AudioWaveform height={20} /> }
];
